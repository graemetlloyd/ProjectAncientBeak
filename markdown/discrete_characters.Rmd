...
```{r plot sum of variances over time by region}
...
```{r plot sum of ranges over time by region}
...
```{r plot centroid medians over time by region}
...
```{r plot sum of variances in each group by region}
par(mfrow = c(2, 3))
...
```{r plot sum of ranges in each group by region}
par(mfrow = c(2, 3))
...
```{r plot centroid medians in each group by region}
par(mfrow = c(2, 3))
